            ...
            <div className="col-2">
                ...
                {cartItems.length === 0 ? <MessageBox>Cart is empty.<Link to="/">Go Shopping</Link></MessageBox> :
                    (<ul>{cartItems.map(item =>
                        <li key={item.product}><div className="row"><div><img src={item.image} alt={item.name} className="small"></img></div>
            ...
            <div className="col-1">
                <div className="card card-body">
                    <ul>
                        <li>
                            <h2>
                                Subtotal ({cartItems.reduce(a => a, 0)} items) : ${cartItems.reduce((a, c) => a + c.price, 0)}
                            </h2>
                        </li>
                        <li>
